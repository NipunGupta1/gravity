...
export class ToolExecuter {
    //overlay is a map of file paths to their content, representing the current state of the file system as seen by the agent. deleted is a set of file paths that have been deleted by the agent. norm is a function that normalizes a relative path to a posix path and removes any leading "./".
    private overlay = new Map<string, string>();
    //deleted is a set of file paths that have been deleted by the agent.
    private deleted = new Set<string>();
    //norm is a function that normalizes a relative path to a posix path and removes any leading "./".
